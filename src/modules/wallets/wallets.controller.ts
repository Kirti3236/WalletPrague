...
export class WalletsController {
  ...
  @Get('dashboard')
  @ApiOperation({ summary: '🔐 Get wallet dashboard (balance + recent transactions + user info)' })
  @ApiOkResponse({ description: 'Returns wallet info, user details, and recent transactions' })
  async dashboard(@GetUser() currentUser: User, @Query('currency') currency = 'LPS') {
