import { IsString, IsUUID, IsOptional, IsNumber, IsBoolean, IsIn } from 'class-validator';
...
export class TransferConfirmationDto {
  ...
  @ApiPropertyOptional({ description: 'User ID for confirmation', example: 'uuid-here' })
  @IsOptional()
  @IsUUID()
  user_id?: string;
}
